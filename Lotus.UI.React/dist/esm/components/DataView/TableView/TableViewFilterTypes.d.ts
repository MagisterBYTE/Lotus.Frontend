...
export declare const EditTableFilterEnumNull: (column: any, onSelectFilterMode: (filterMode: MRT_FilterOption) => void) => React.ReactNode[];
export declare const EditTableFilterNumber: (column: any, onSelectFilterMode: (filterMode: MRT_FilterOption) => void) => React.ReactNode[];
export declare const EditTableFilterNumberNull: (column: any, onSelectFilterMode: (filterMode: MRT_FilterOption) => void) => React.ReactNode[];
export declare const EditTableFilterArray: (column: any, onSelectFilterMode: (filterMode: MRT_FilterOption) => void) => React.ReactNode[];
//# sourceMappingURL=TableViewFilterTypes.d.ts.map