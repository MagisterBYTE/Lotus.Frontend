 ...
 */
export class ColorPaletteVariants {
    /**
     * Основной цвет - синяя палитра MUI
     */
    static Primary = new ColorVariants(new Color('#e3f2fd'), // 0 - white
     ...
     */
    static Secondary = new ColorVariants(new Color('#f3e5f5'), // 0 - white
     ...
     */
    static Error = new ColorVariants(new Color('#ffebee'), // 0 - white
     ...
     */
    static Warning = new ColorVariants(new Color('#fff3e0'), // 0 - white
     ...
     */
    static Info = new ColorVariants(new Color('#e1f5fe'), // 0 - white
     ...
     */
    static Success = new ColorVariants(new Color('#e8f5e8'), // 0 - white
     ...
     */
    static MuiBlueGrey = new ColorVariants(new Color('#eceff1'), // 0 - white
...
//# sourceMappingURL=ColorPaletteVariants.js.map