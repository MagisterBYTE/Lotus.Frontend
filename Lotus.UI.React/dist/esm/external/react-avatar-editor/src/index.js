...
const drawGrid = (context, x, y, width, height, gridColor) => {
...
export class AvatarEditor extends React.Component {
    ...
    getImage() {
        ...
        if (!image.resource) {
            throw new Error('No image resource available, please report this to: https://github.com/mosch/react-avatar-editor/issues');
        }
    ...
    paint(context) {
        ...
        if (this.props.borderColor) {
            ...
            context.lineWidth = 1;
            context.beginPath();
            drawRoundedRect(context, borderSizeX + 0.5, borderSizeY + 0.5, width - borderSizeX * 2 - 1, height - borderSizeY * 2 - 1, borderRadius);
            context.stroke();
        }
        if (this.props.showGrid) {
            drawGrid(context, borderSizeX, borderSizeY, width - borderSizeX * 2, height - borderSizeY * 2, this.props.gridColor);
        }
        context.restore();
    }
    handleMouseDown = (e) => {
