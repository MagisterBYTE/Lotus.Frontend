...
export const MRT_FilterRangeSlider = ({ header, table, ...rest }) => {
    ...
    return (_jsx(RangeSlider, { className: clsx('mrt-filter-range-slider', classes.root), max: max, min: min, onChange: (values) => {
...
//# sourceMappingURL=MRT_FilterRangeSlider.js.map