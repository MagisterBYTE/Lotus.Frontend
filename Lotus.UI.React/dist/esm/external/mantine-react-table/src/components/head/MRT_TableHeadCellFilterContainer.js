...
export const MRT_TableHeadCellFilterContainer = ({ header, table, ...rest }) => {
    ...
    return (_jsx(Collapse, { expanded: showColumnFilters || columnFilterDisplayMode === 'popover', children: _jsxs(Flex, { direction: "column", ...rest, children: [_jsxs(Flex, { align: "flex-end", children: [columnDef.filterVariant === 'checkbox' ? (_jsx(MRT_FilterCheckbox, { column: column, table: table })) : columnDef.filterVariant === 'range-slider' ? (_jsx(MRT_FilterRangeSlider, { header: header, table: table })) : ['date-range', 'range'].includes(columnDef.filterVariant ?? '') ||
