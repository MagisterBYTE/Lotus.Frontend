...
export const MRT_ToolbarAlertBanner = ({ stackAlertBanner, table, ...rest }) => {
    ...
    return (_jsx(Collapse, { expanded: showAlertBanner || !!selectedAlert || !!groupedAlert, transitionDuration: stackAlertBanner ? 200 : 0, children: _jsx(Alert, { color: "blue", icon: false, ...alertProps, className: clsx(classes.alert, stackAlertBanner &&
