...
import { ColorVariantsHelper, TColorSemantics, TColorVariantNames } from 'lotus-core/modules/color';
import { TThemeColorPalettes } from './ThemeColorPalette';
/**
 * Массив всех возможных типов TThemeColor
 * TColorSemantic типы расположены в начале массива
 */
export const TThemeColors = [
...
export function instanceOfThemeColor(color) {
    if (typeof color === 'string') {
        return themeColorsSet.has(color);
    }
    return false;
}
/**
 ...
 */
export function createThemeColor(color, colorVariant) {
...
export function deconstructionThemeColor(color) {
    ...
    if (TThemeColorPalettes.includes(color)) {
 ...
 */
export function nextThemeColor(color, delta) {
