import { LocalizationCore, LocalizationHelper, TLanguageType, TLanguageTypes } from 'lotus-core/localization';
...
export function useTableViewLocalization() 
{
  ...
  const [localization, setLocalization] = useState<object>(localizationFullRU);
