import { instanceOfSizeType, TCssFontSize } from '#types';
...
export class FontSizes extends SizeDimensions
{
   ...
   */
  public static getFromCssVariable(value?: string|number):TCssFontSize|undefined
  {
   ...
   */
  public getSizeShadow(value?: string|number):number
  {
    if (value)
    {
      switch (value)
   ...
   */
  public getSizeStroke(value?: string|number):number
  {
    if (value)
    {
      switch (value)
