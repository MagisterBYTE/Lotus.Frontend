...
export class MarginSizes extends SizeDimensions 
{
   ...
   */
  public static readonly Default = new MarginSizes(0.30 * 16, 0.5 * 16, 0.750 * 16, 1 * 16, 1.5 * 16, 2.0 * 16, 2.5 * 16);
  // #endregion
   ...
   */
  public static getFromCssVariable(value?: string | number): TCssMargin | undefined
  {
