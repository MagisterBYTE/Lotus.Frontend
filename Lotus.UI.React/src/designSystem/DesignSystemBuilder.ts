 ...
 * 
 */
export abstract class DesignSystemBuilder
{
  // eslint-disable-next-line complexity
  public static create(props?: Partial<IDesignSystem>, colorScheme?:TColorScheme):IDesignSystem
  {
    const designSystem:IDesignSystem =
    {
      //
      // РАЗМЕРЫ
      //
