 ...
 */
export abstract class BackgroundPropertiesHelper
{
   ...
   */
  public static createBoxShadowProps(props: IGeneralBackgroundProperties): TCssProperties
  {
    const backProps: TCssProperties = {};
  ...
  public static getBoxShadowPropsValue(elevation?: TShadowElevation, color?: string): TCssBoxShadow | undefined
  {
