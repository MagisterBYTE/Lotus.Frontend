...
import { TCssBorderStyles, TSizeTypes, TIconPlacements,TShadowElevations, TTextEffects } from '#types';
...
export abstract class ArgTypesStory
{
  public static readonly Padding: Partial<ArgTypes<IGeneralPaddingProperties>> = {
    p: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    pl: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    pt: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    pr: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    pb: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } }
  };

  public static readonly Margin: Partial<ArgTypes<IGeneralMarginProperties>> = {
    m: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    ml: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    mt: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    mr: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } },
    mb: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Padding & Margin' } }
  };
  ...
  public static readonly Border: Partial<ArgTypes<IGeneralBorderProperties>> = {
    ...
    bdRadius: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Border' } },
    bdRadiusTopLeft: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Border' } },
    bdRadiusTopRight: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Border' } },
    bdRadiusBottomLeft: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Border' } },
    bdRadiusBottomRight: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Border' } },
  ...
  public static readonly Text: Partial<ArgTypes<IGeneralTextProperties>> = {
    fontSize: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Text' } },
    ...
    textLineSpacing: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Text' } },
  ...
  public static readonly Icon: Partial<ArgTypes<IGeneralIconProperties>> = {
    ...
    iconSize: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Icon' } },
  ...
  public static readonly BaseFieldSize: Partial<ArgTypes<IBaseFieldProps>> = {
    ...
    size: { control: 'inline-radio', options: [...TSizeTypes, undefined], table: { category: 'Size' } },
