 ...
 */
export class RandomXorShift implements IRandomGenerator
{
  // #region Const
  /**
   ...
   */
  private static readonly SEED_MIXER: bigint = 0x9e3779b97f4a7c15n;
  // #endregion
   ...
   */
  public generateInteger(): number
  {
    let x: bigint = this._s0;
    const y: bigint = this._s1;
