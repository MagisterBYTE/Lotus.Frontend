...
export abstract class HumanizerPerson 
{
   ...
   */
  public static getShortName(personInfo: IPersonInfo | null | undefined, skipIfNameEmpty: boolean = true): string 
  {
    ...
    if (!name && skipIfNameEmpty) return '';

    // Если нет имени, но разрешено показывать только фамилию
    if (!name && !skipIfNameEmpty) return surname;
   ...
   */
  public static getDisplayName(personInfo: IPersonInfo | null | undefined, includePatronymic: boolean = false, fallbackToShortName: boolean = true): string 
  {
    if (!personInfo) return '';
   ...
   */
  public static getFullName(personInfo: IPersonInfo | null | undefined, skipMiddleNameIfEmpty: boolean = true): string 
  {
    if (!personInfo) return '';
   ...
   */
  public static getInitials(personInfo: IPersonInfo | null | undefined): string 
  {
    if (!personInfo) return '';
   ...
   */
  public static getFormattedName(personInfo: IPersonInfo | null | undefined, format: TPersonNameFormat): string 
  {
    switch (format) 
    {
      case 'short':
