...
export abstract class LightColorPalette
{
  ...
  public static readonly Secondary: ColorVariants = new ColorVariants(
    new Color('#faf5ff'), // 0 - white (вторичный фон)
  ...
  public static readonly Error: ColorVariants = new ColorVariants(
    new Color('#fff5f5'), // 0 - white (фон ошибок)
  ...
  public static readonly Warning: ColorVariants = new ColorVariants(
    new Color('#fffaf0'), // 0 - white (фон предупреждений)
  ...
  public static readonly Info: ColorVariants = new ColorVariants(
    new Color('#f0f9ff'), // 0 - white (фон информации)
  ...
  public static readonly Success: ColorVariants = new ColorVariants(
    new Color('#f0fff4'), // 0 - white (фон успеха)
   ...
   */
  public static readonly MuiBlueGray: ColorVariants = new ColorVariants(
 ...
 */
export abstract class DarkColorPalette
{
  /**
   * Основной цвет - синяя палитра MUI (адаптированная для темного фона)
   */
  public static readonly Primary: ColorVariants = new ColorVariants(
    new Color('#0a1c3a'), // 0 - black (самый темный фон)
   ...
   */
  public static readonly Secondary: ColorVariants = new ColorVariants(
    new Color('#1a0a2a'), // 0 - black (вторичный фон)
   ...
   */
  public static readonly Error: ColorVariants = new ColorVariants(
    new Color('#2a0a0a'), // 0 - black (фон ошибок)
   ...
   */
  public static readonly Warning: ColorVariants = new ColorVariants(
    new Color('#2a1c0a'), // 0 - black (фон предупреждений)
   ...
   */
  public static readonly Info: ColorVariants = new ColorVariants(
    new Color('#0a1a2a'), // 0 - black (фон информации)
   ...
   */
  public static readonly Success: ColorVariants = new ColorVariants(
    new Color('#0a1a0a'), // 0 - black (фон успеха)
   ...
   */
  public static readonly MuiBlue: ColorVariants = new ColorVariants(
    new Color('#051e3a'), // 0 - black (самый темный)
