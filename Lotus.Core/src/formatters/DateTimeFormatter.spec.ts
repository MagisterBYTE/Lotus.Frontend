  ...
  describe('Browser compatibility simulation', () => 
  {
    test('should work without Intl.DateTimeFormat options', () => 
    {
      ...
      try 
      {
        ...
        const mockDateTimeFormat = function (locale?: string, options?: any) 
        {
          return {
            format: (date: Date) => date.toLocaleDateString(locale)
          };
        } as any;
...
describe('DateTimeFormatter - Edge cases', () => 
{
  ...
  describe('Invalid input handling', () => 
  {
    ...
    {
      expect(() => DateTimeFormatter.formatRelativeValue(1, 'invalid' as any)).toThrow();
    });
  });
