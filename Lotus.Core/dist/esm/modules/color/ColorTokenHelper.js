...
export class ColorTokenHelper {
    ...
    static instanceOf(color) {
        if (typeof color === 'string') {
            return ColorTokenHelper.ColorTokenMap.has(color);
        }
        return false;
    }
    /**
     ...
     */
    static getVariantFromToken(token) {
        const tuple = ColorTokenHelper.ColorTokenMap.get(token);
        if (!tuple) {
     ...
     */
    static getBaseColorFromToken(token) {
        const tuple = ColorTokenHelper.ColorTokenMap.get(token);
        if (!tuple) {
            throw new Error(`Invalid color token: ${token}`);
        }
    ...
    static deconstruction(color) {
        ...
        if (ColorTokenHelper.ColorTokenMap.has(color)) {
            const tuple = ColorTokenHelper.ColorTokenMap.get(color);
            return tuple;
        }
...
//# sourceMappingURL=ColorTokenHelper.js.map