...
export declare abstract class ColorCssHelper {
     ...
     */
    static getColorCss(color?: string): string | undefined;
    /**
     ...
     */
    static getColorCssWithAlpha(color?: string, alpha?: number): string | undefined;
    /**
     * Получить контрастный корректный цвет для Css
     * @param color Цвет любого типа
     * @returns Контрастный корректный цвет для Css или undefined
     */
    static getColorContrastCss(color?: string): string | undefined;
}
