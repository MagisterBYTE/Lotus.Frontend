 ...
 */
export class GenerationNoise2D {
    /**
     ...
     */
    static smoothNoiseSingle2D(x, y) {
        const corners = (GenerationNoise2D.noiseSingle2DV2(x - 1, y - 1) +
            GenerationNoise2D.noiseSingle2DV2(x + 1, y - 1) +
            GenerationNoise2D.noiseSingle2DV2(x - 1, y + 1) +
            GenerationNoise2D.noiseSingle2DV2(x + 1, y + 1)) /
            16;
        const sides = (GenerationNoise2D.noiseSingle2DV2(x - 1, y) +
     ...
     */
    static interpolatedNoiseSingle2D(x, y) {
...
//# sourceMappingURL=GenerationNoise2D.js.map