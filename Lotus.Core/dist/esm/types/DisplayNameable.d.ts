 ...
 */
export declare function instanceOfDisplayNameable(value: unknown): value is IDisplayNameable;
/**
 * Преобразование объекта к интерфейсу {@link IDisplayNameable}
 * @param value Объект для преобразования
 * @returns Объект реализующий интерфейс или undefined если объект не поддерживает интерфейс
 */
export declare function castToDisplayNameable(value: unknown): IDisplayNameable | undefined;
//# sourceMappingURL=DisplayNameable.d.ts.map