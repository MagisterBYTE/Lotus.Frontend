...
describe('TypedRoute', () => {
    ...
    describe('Basic functionality', () => {
        const simpleRoute = new TypedRoute('/home');
        const authRoute = new TypedRoute('/dashboard', true);
    ...
    describe('Parameter constraints', () => {
        const constrainedRoute = new TypedRoute('/admin/:role/:action', true, {
            role: USER_ROLES,
